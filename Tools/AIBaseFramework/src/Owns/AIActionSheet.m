...
@implementation AISheetItem@end

@interface AIActionSheetCell : UICollectionViewCell
...
@implementation AIActionSheetCell
...
- (instancetype)initInParentView:(UIView*)parentView delegate:(id <AIActionSheetDelegate>)delegate {
    ...
    if (self) {
        ...
        // 注册
        [_mainMenuView registerClass:[AIActionSheetCell class] forCellWithReuseIdentifier:kAIActionSheetCellIdentifier];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    AIActionSheetCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:kAIActionSheetCellIdentifier forIndexPath:indexPath];
